...
@ReactModule(name = Rfid8500ZebraModule.NAME)
public class Rfid8500ZebraModule extends ReactContextBaseJavaModule implements LifecycleEventListener {
  public static final String NAME = "Rfid8500Zebra";
  ...
  public Rfid8500ZebraModule(ReactApplicationContext reactContext) {
    super(reactContext);
